...
class CameraApi {
  ...
  Future<double> getCameraFStop() async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.camera_avfoundation.CameraApi.getCameraFStop$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
    BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
  ...
  Future<double> getCameraShutter() async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.camera_avfoundation.CameraApi.getCameraShutter$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
    BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
  ...
  Future<double> getCameraISO() async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.camera_avfoundation.CameraApi.getCameraISO$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
    BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
  ...
  Future<double> getCameraTemperature() async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.camera_avfoundation.CameraApi.getCameraTemperature$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
    BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
